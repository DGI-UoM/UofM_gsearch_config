<xsl:stylesheet version="1.0"
        ...
        <xsl:variable name="to_traverse">
          ...
          <xsl:message>diff: <xsl:value-of select="@uri"/></xsl:message>
              ...
              <xsl:variable name="new_query">
                <!-- 2014-07-07 - whikloj
                  Calling the recursive string replacement to put the new
                  @uri in to the query
                //-->
  ...
  <!-- 2014-07-07 - whikloj
  //    New recursive string replacement
  //    Replaces ALL instances of $find in $string with $replace
  //    to allow us to use the actual PID in more places, 
  //    which makes a faster SPARQL query -->
