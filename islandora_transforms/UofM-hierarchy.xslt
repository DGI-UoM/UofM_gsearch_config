<xsl:stylesheet version="1.0"
  ...
  <xsl:include href="/usr/local/fedora/tomcat/webapps/fedoragsearch/WEB-INF/classes/fgsconfigFinal/index/FgsIndex/islandora_transforms/UofM-traverse-graph.xslt"/>
  ...
  <xsl:template name="get-ancestors">
    ...
    <xsl:variable name="graph">
      ...
      <xsl:call-template name="_traverse_graph">
        ...
        <!-- 2014-07-07 - whikloj
        //   Modified query to make greater use of the actual 
        //   PID in the Sparql query -->
